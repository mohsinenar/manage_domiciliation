...
class Company(models.Model):
    ...
    num_cert = fields.Integer(required=True,string="NC Négatif")
    date_cert = fields.Date(required=False,string="Date C Négatif")
    company_ICE = fields.Integer(required=True,string="ICE")
    patente = fields.Integer(required=True,string="Patente")
    numero_affiliation = fields.Integer(required=True,string="Numéro d'affiliation")
    phone = fields.Char(required=True,string="Tel. FIX")
    ...
    date_debut = fields.Date(compute='_compute_date_debut', string='Date début')
